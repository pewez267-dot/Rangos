...
public class CollectionRegistry {
   ...
   public static void loadCollections(class_3300 resourceManager) {
      ...
      try {
         Map<class_2960, class_3298> resources = resourceManager.method_14488("collections", locationx -> locationx.method_12832().endsWith(".json"));
         ...
         for (Entry<class_2960, class_3298> entry : resources.entrySet()) {
            ...
            try (
               InputStream stream = entry.getValue().method_14482();
