...
public class DownState {
    ...
    public final Map<UUID, Integer> reviverWindow = new HashMap<UUID, Integer>();
    ...
    public final List<MobEffectInstance> snapshotEffects = new ArrayList<MobEffectInstance>();
    ...
    public DownState(UUID playerUuid, int totalTicks, ResourceKey<Level> dim, Vec3 pos) {
        ...
        this.bossBar = new ServerBossEvent((Component)Component.literal((String)"Noqueado"), BossEvent.BossBarColor.RED, BossEvent.BossBarOverlay.PROGRESS);
