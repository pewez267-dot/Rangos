package com.fantasticranks.gui;

import com.fantasticranks.nametag.NametagBuilder;
import net.minecraft.client.gui.GuiGraphics;

/**
 * Shared dark "Battle Pass" palette (Valorant/Apex inspired, matching Fantastic Pass) and
 * small drawing helpers used by every Fantastic Ranks screen and widget. Colors are stored
 * as 0xRRGGBB; OR with {@code 0xFF000000} when an opaque ARGB value is required.
 */
