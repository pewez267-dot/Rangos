 ...
 * scale) but applies the configured line scale and vertical offset so the line sits just
 * beneath the name without modifying any vanilla rendering.
 */
public final class NametagRenderer {
    ...
    public static void render(Entity entity, Component line, PoseStack poseStack,
        ...
        float lineScale = (float) (double) RanksConfig.LINE_SCALE.get();
        float verticalOffset = (float) (double) RanksConfig.VERTICAL_OFFSET.get();
