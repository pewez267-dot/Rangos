...
public final class FSCrateCommand
{
    ...
    public static void register(final CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("fscrate").requires(s -> s.hasPermission(4))).executes(FSCrateCommand::help)).then(Commands.literal("help").executes(FSCrateCommand::help))).then(Commands.literal("create").executes(FSCrateCommand::create))).then(Commands.literal("list").executes(FSCrateCommand::list))).then(((LiteralArgumentBuilder)Commands.literal("edit").executes(c -> usage((CommandContext<CommandSourceStack>)c, "/fscrate edit <crate>"))).then(Commands.argument("crate", (ArgumentType)StringArgumentType.word()).suggests((c, b) -> suggestCrates((CommandContext<CommandSourceStack>)c, b)).executes(FSCrateCommand::edit)))).then(((LiteralArgumentBuilder)Commands.literal("give").executes(c -> usage((CommandContext<CommandSourceStack>)c, "/fscrate give <jugador> <crate>"))).then(((RequiredArgumentBuilder)Commands.argument("player", (ArgumentType)EntityArgument.player()).executes(c -> usage((CommandContext<CommandSourceStack>)c, "/fscrate give <jugador> <crate>"))).then(Commands.argument("crate", (ArgumentType)StringArgumentType.word()).suggests((c, b) -> suggestCrates((CommandContext<CommandSourceStack>)c, b)).executes(FSCrateCommand::giveCrate))))).then(((LiteralArgumentBuilder)Commands.literal("key").executes(c -> usage((CommandContext<CommandSourceStack>)c, "/fscrate key give <jugador> <tier>"))).then(((LiteralArgumentBuilder)Commands.literal("give").executes(c -> usage((CommandContext<CommandSourceStack>)c, "/fscrate key give <jugador> <tier>"))).then(((RequiredArgumentBuilder)Commands.argument("player", (ArgumentType)EntityArgument.player()).executes(c -> usage((CommandContext<CommandSourceStack>)c, "/fscrate key give <jugador> <tier>  (tier: common/rare/epic/legendary/mythic)"))).then(Commands.argument("tier", (ArgumentType)StringArgumentType.word()).suggests((c, b) -> suggestTiers((CommandContext<CommandSourceStack>)c, b)).executes(FSCrateCommand::giveKey)))))).then(((LiteralArgumentBuilder)Commands.literal("preview").executes(c -> usage((CommandContext<CommandSourceStack>)c, "/fscrate preview <crate>"))).then(Commands.argument("crate", (ArgumentType)StringArgumentType.word()).suggests((c, b) -> suggestCrates((CommandContext<CommandSourceStack>)c, b)).executes(FSCrateCommand::preview)))).then(((LiteralArgumentBuilder)Commands.literal("delete").executes(c -> usage((CommandContext<CommandSourceStack>)c, "/fscrate delete <crate>"))).then(Commands.argument("crate", (ArgumentType)StringArgumentType.word()).suggests((c, b) -> suggestCrates((CommandContext<CommandSourceStack>)c, b)).executes(FSCrateCommand::delete))));
    }
    ...
    private static int help(final CommandContext<CommandSourceStack> ctx) {
        ...
        s.sendSystemMessage((Component)Component.literal("§e/fscrate edit <crate> §7- edita una crate guardada"));
