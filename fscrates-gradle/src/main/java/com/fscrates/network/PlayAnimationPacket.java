...
public class PlayAnimationPacket
{
    ...
    public PlayAnimationPacket(final BlockPos pos, final String animationId, final int rarityColor, final int winnerIndex, final CompoundTag candidates) {
        this.pos = pos;
    ...
    public static void handle(final PlayAnimationPacket msg, final Supplier<NetworkEvent.Context> ctx) {
        ...
        context.enqueueWork(() -> DistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> () -> ClientPacketHandler.playAnimation(msg.pos, msg.animationId, msg.rarityColor, msg.winnerIndex, msg.candidates)));
