...
public class ParticleLayer
{
    ...
    public static List<ParticleLayer> defaults() {
        ...
        ring.interval = 8;
        list.add(ring);
        final ParticleLayer spiral = new ParticleLayer("minecraft:dust", Phase.ANTICIPATION, Shape.SPIRAL);
        spiral.count = 16;
        spiral.radius = 0.85;
        spiral.yOffset = 0.2;
        spiral.speed = 0.05;
        ...
        list.add(spiral);
        final ParticleLayer spiralSpark = new ParticleLayer("minecraft:end_rod", Phase.ANTICIPATION, Shape.SPIRAL);
