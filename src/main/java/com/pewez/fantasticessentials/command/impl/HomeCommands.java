...
public final class HomeCommands {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        dispatcher.register(Commands.literal("sethome")
                .requires(Permissions.require("fantasticessentials.command.sethome", 0))
        ...
        dispatcher.register(Commands.literal("delhome")
                .requires(Permissions.require("fantasticessentials.command.delhome", 0))
                .then(Commands.argument("name", StringArgumentType.word())
        ...
        dispatcher.register(Commands.literal("home")
                .requires(Permissions.require("fantasticessentials.command.home", 0))
                .then(Commands.argument("name", StringArgumentType.word())
                        .suggests(HOME_SUGGESTIONS)
        ...
        dispatcher.register(Commands.literal("homes")
                .requires(Permissions.require("fantasticessentials.command.homes", 0))
