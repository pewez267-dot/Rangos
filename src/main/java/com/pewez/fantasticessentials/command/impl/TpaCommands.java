...
public final class TpaCommands {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(Commands.literal("tpa")
                .requires(Permissions.require("fantasticessentials.command.tpa", 0))
        ...
        dispatcher.register(Commands.literal("tpaccept")
                .requires(Permissions.require("fantasticessentials.command.tpaccept", 0))
                .executes(context -> accept(context, null))
                .then(Commands.argument("player", EntityArgument.player())
                        .executes(context -> accept(context, EntityArgument.getPlayer(context, "player")))));

        dispatcher.register(Commands.literal("tpdeny")
                .requires(Permissions.require("fantasticessentials.command.tpdeny", 0))
        ...
        dispatcher.register(Commands.literal("tpall")
                .requires(Permissions.require("fantasticessentials.command.tpall", 2))
