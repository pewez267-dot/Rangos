...
/**
 * Live preview of the resulting nametag: the player's name in white with the styled
 * rank line beneath it, exactly as it will render in-world. Re-reads its style/text
 * every frame so it updates on every keystroke and color change.
 */
public class NametagPreviewWidget extends AbstractWidget {
    ...
    protected void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Faux "in-world" backdrop so light text remains readable.
