...
/**
 * Client-side cache of per-player nametag state, populated by the nametag update
 * packet and read by the renderer Mixin. Uses a concurrent map because it is written
 * on the client network thread and read on the client render thread.
 */
