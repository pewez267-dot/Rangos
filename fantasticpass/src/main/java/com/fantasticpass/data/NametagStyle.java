...
/**
 * Complete visual configuration of a pass-rank nametag line. Pure data with NBT
 * and network serialization; usable on both logical sides. Component construction
 * lives in {@code com.fantasticpass.nametag.NametagBuilder}.
 */
public final class NametagStyle {
    ...
    public NametagStyle() {
        this.color = 0x00E5FF; // electric cyan default
        this.gradientStart = 0x00E5FF;
        this.gradientEnd = 0xFFD700; // gold
    }
