...
public final class MiscCommands {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        dispatcher.register(Commands.literal("flyspeed")
                .requires(Permissions.require("essentials.command.flyspeed", 2))
        ...
        dispatcher.register(Commands.literal("walkspeed")
                .requires(Permissions.require("essentials.command.walkspeed", 2))
                .then(Commands.argument("speed", FloatArgumentType.floatArg(0.0f, 10.0f))
        ...
        dispatcher.register(Commands.literal("glow")
                .requires(Permissions.require("essentials.command.glow", 2))
        ...
        dispatcher.register(Commands.literal("invulnerable")
                .requires(Permissions.require("essentials.command.invulnerable", 2))
        ...
        dispatcher.register(Commands.literal("hat")
                .requires(Permissions.require("essentials.command.hat", 2))
                .executes(MiscCommands::hat));

        // /repair
        dispatcher.register(Commands.literal("repair")
                .requires(Permissions.require("essentials.command.repair", 2))
                .executes(MiscCommands::repair));

        // /ping [player]
        dispatcher.register(Commands.literal("ping")
                .requires(Permissions.require("essentials.command.ping", 0))
        ...
        dispatcher.register(Commands.literal("whois")
                .requires(Permissions.require("essentials.command.whois", 0))
