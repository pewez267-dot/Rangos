...
public final class NametagUpdatePacket {
   ...
   public static void handle(NametagUpdatePacket packet, Supplier<Context> ctx) {
      Context context = ctx.get();
      context.enqueueWork(() -> DistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> () -> ClientPacketHandler.updateNametag(packet)));
