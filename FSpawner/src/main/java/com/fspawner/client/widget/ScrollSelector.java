...
/**
 * A modern, scrollable + searchable selection list. Reused for entities, items,
 * effects and infernal modifiers. Supports mouse wheel, click selection and a
 * draggable scrollbar.
 */
public class ScrollSelector<T> extends AbstractWidget {
    ...
    private Function<T, Boolean> checked; // optional checkbox state
    ...
    protected void updateWidgetNarration(NarrationElementOutput out) {
        // selection lists are not narrated in detail
    }
}
